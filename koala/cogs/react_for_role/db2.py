...
@assign_session
def add_rfr_message_emoji_role(emoji_role_id: int, emoji_raw: str, role_id: int):
    """
...
@assign_session
def remove_rfr_message_emoji_roles(emoji_role_id: int):
    """
...
@assign_session
def remove_rfr_message(guild_id: int, channel_id: int, message_id: int):
    """
...
@assign_session
def get_rfr_message(guild_id: int, channel_id: int, message_id: int) -> Optional[Tuple[int, int, int, int]]:
    """
...
@assign_session
def get_guild_rfr_messages(guild_id: int):
    """
...
@assign_session
def add_guild_rfr_required_role(guild_id: int, role_id: int):
    """
...
@assign_session
def remove_guild_rfr_required_role(guild_id: int, role_id: int):
    """
...
@assign_session
def get_guild_rfr_required_roles(guild_id) -> List[int]:
    """
